...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Cho phép tất cả origin kết nối (Vercel, localhost, v.v.)
...
app.include_router(audit_logs.router, prefix=f"{settings.API_V1_STR}/audit-logs", tags=["audit_logs"])from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from app.core.config import settings
